...
# Define the column names for UK Price Paid Data
...
HousePrices2020 <- read_csv("Obtained Data/pp-2020.csv", col_names = FALSE)
colnames(HousePrices2020) <- price_paid_headers

HousePrices2021 <- read_csv("Obtained Data/pp-2021.csv", col_names = FALSE)
colnames(HousePrices2021) <- price_paid_headers

HousePrices2022 <- read_csv("Obtained Data/pp-2022.csv", col_names = FALSE)
colnames(HousePrices2022) <- price_paid_headers

HousePrices2023 <- read_csv("Obtained Data/pp-2023.csv", col_names = FALSE)
colnames(HousePrices2023) <- price_paid_headers

HousePrices2024 <- read_csv("Obtained Data/pp-2024.csv", col_names = FALSE)
...
crimeRate04s = read_csv("Obtained Data/2024-04-south-yorkshire-street.csv")
crimeRate04n = read_csv("Obtained Data/2024-04-west-yorkshire-street.csv")

crimeRate03s = read_csv("Obtained Data/2025-03-south-yorkshire-street.csv")
crimeRate03n = read_csv("Obtained Data/2025-03-west-yorkshire-street.csv")

crimeRate14s = read_csv("Obtained Data/2025-04-south-yorkshire-street.csv")
crimeRate14n = read_csv("Obtained Data/2025-04-west-yorkshire-street.csv")

crimeRate05s = read_csv("Obtained Data/2024-05-south-yorkshire-street.csv")
crimeRate05n = read_csv("Obtained Data/2024-05-west-yorkshire-street.csv")

crimeRate06s = read_csv("Obtained Data/2024-06-south-yorkshire-street.csv")
crimeRate06n = read_csv("Obtained Data/2024-06-west-yorkshire-street.csv")

crimeRate07s = read_csv("Obtained Data/2024-07-south-yorkshire-street.csv")
crimeRate07n = read_csv("Obtained Data/2024-07-west-yorkshire-street.csv")

crimeRate08s = read_csv("Obtained Data/2024-08-south-yorkshire-street.csv")
crimeRate08n = read_csv("Obtained Data/2024-08-west-yorkshire-street.csv")

crimeRate09s = read_csv("Obtained Data/2024-09-south-yorkshire-street.csv")
crimeRate09n = read_csv("Obtained Data/2024-09-west-yorkshire-street.csv")

crimeRate10s = read_csv("Obtained Data/2024-10-south-yorkshire-street.csv")
crimeRate10n = read_csv("Obtained Data/2024-10-west-yorkshire-street.csv")

crimeRate11s = read_csv("Obtained Data/2024-11-south-yorkshire-street.csv")
crimeRate11n = read_csv("Obtained Data/2024-11-west-yorkshire-street.csv")

crimeRate12s = read_csv("Obtained Data/2024-12-south-yorkshire-street.csv")
crimeRate12n = read_csv("Obtained Data/2024-12-west-yorkshire-street.csv")

crimeRate01s = read_csv("Obtained Data/2025-01-south-yorkshire-street.csv")
crimeRate01n = read_csv("Obtained Data/2025-01-west-yorkshire-street.csv")

crimeRate02s = read_csv("Obtained Data/2025-02-south-yorkshire-street.csv")
crimeRate02n = read_csv("Obtained Data/2025-02-west-yorkshire-street.csv")

p2l = read_csv("Obtained Data/p2l.csv")
...
school = read_csv('Obtained Data/schooldata.csv')
...
band = read_csv('Obtained Data/bandwidth.csv')
...
write.csv(Towns, "Cleaned Data/Towns.csv", row.names = FALSE)
write.csv(cleanHousePrices, "Cleaned Data/cleanHousePrices.csv", row.names = FALSE)
write.csv(CleanCrimeData, "Cleaned Data/cleanCrimeRate.csv", row.names = FALSE)
write.csv(cleanSchool, "Cleaned Data/cleanSchool.csv", row.names = FALSE)
write.csv(cleanBand, "Cleaned Data/cleanBand.csv", row.names = FALSE)
